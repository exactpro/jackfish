...
namespace UIAdapterRunner
{
    public partial class UIAdapterRunner : Form
    {
        public UIAdapterRunner()
        {
            ...
            UIAdapter.Program.FindAllForLocator(arr, arr.Length, getStringId(ref arr), (int)UIAdapter.ControlKind.ComboBox, null, ".//ComboBox[@uid=\"autocompleteBox\"]", null, null, null, null, false);
