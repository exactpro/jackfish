...
namespace UIAdapterRunner
{
    public partial class UIAdapterRunner : Form
    {
        public UIAdapterRunner()
        {
            InitializeComponent();
            int[] arr = new int[100];
            UIAdapter.Program.Run("C:/Users/user_adm/workspace - git/JackFish/TestProject/../mocks/win/mock_win/run/mock_win.exe", "", "");
            ...
            UIAdapter.Program.FindAllForLocator(arr, arr.Length, getStringId(ref arr), 17, "Slider", null, null, null, null, null, true);
