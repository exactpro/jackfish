...
public class LibraryWizard extends AbstractWizard
{
	...
	protected void initDialog(BorderPane borderPane)
	{
		...
		nameOfNameSpace.textProperty()
				.addListener((observable, oldValue, newValue) -> this.newNameSpaceName = newValue);
	...
	public void init(IContext context, WizardManager wizardManager, Object... parameters)
	{
		...
		this.oldNameSpaceName = currentSubCase.getParent().getClass() == NameSpace.class
