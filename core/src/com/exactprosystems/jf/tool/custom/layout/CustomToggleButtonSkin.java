...
public abstract class CustomToggleButtonSkin extends ToggleButtonSkin
{
	...
	public CustomToggleButtonSkin(ToggleButton toggleButton)
	{
		super(toggleButton);
