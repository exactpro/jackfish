...
{	
	...
	Tree        	("Tree", 			false, 	CLICK, 			USE, FOREACH, GET_ATTR, CHECK_ATTR, MOVE_XY, CLICK, CLICK_XY, MOVE, PRESS, KEY_UP, KEY_DOWN, COLLAPSE, EXPAND, GET_ROW, GET_ROW_INDEXES, GET_ROW_BY_INDEX),
