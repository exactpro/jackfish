...
{	// 											default		allOther
	...
	TextBox     	("TextBox", 		false,	TEXT, 		FOREACH, REPEAT, USE_LOCATOR, USE, COUNT, DELAY, GET_RECTANGLE, GET_ATTR, CHECK_ATTR, CHECK_ATTR_REGEXP, MOVE, MOVE_XY, CLICK_XY, CLICK, PRESS, KEY_UP, KEY_DOWN, GET_VALUE, CHECK, CHECK_REGEXP, GET, SCRIPT),
