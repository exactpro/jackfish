...
{	
	...
	MenuItem    	("MenuItem", 		false,	CLICK, 			USE, FOREACH, GET_ATTR, CHECK_ATTR, MOVE_XY, CLICK, CLICK_XY, MOVE, GET,  CLICK_XY),
	...
	Slider			("Slider", 			false, 	SET, 			USE, FOREACH, GET_ATTR, CHECK_ATTR, MOVE_XY, CLICK, CLICK_XY, MOVE, PRESS, KEY_UP, KEY_DOWN, GET_VALUE, CHECK, CHECK_REGEXP, CLICK),
	...
	Tree        	("Tree", 			false, 	CLICK, 			USE, FOREACH, GET_ATTR, CHECK_ATTR, MOVE_XY, CLICK, CLICK_XY, MOVE, PRESS, KEY_UP, KEY_DOWN, GET_LIST, COLLAPSE, EXPAND, GET_ROW, GET_ROW_INDEXES, GET_ROW_BY_INDEX),
