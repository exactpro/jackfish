...
{	
	...
	ComboBox    	("ComboBox", 		false,	SELECT,			USE, FOREACH, GET_ATTR, CHECK_ATTR, MOVE_XY, CLICK, CLICK_XY, MOVE, SELECT_BY_INDEX, PRESS, KEY_UP, KEY_DOWN, GET_VALUE, CHECK, CHECK_REGEXP, GET, GET_LIST, CHECK_LIST, TEXT, SCROLL_TO),
	...
	ListView    	("ListView", 		false, 	CLICK,			USE, FOREACH, GET_ATTR, CHECK_ATTR, MOVE_XY, CLICK, CLICK_XY, MOVE, PRESS, KEY_UP, KEY_DOWN, GET_VALUE, CHECK, GET_LIST, CHECK_LIST, SELECT, SELECT_BY_INDEX, SCROLL_TO),
	...
	Panel       	("Panel", 			false,	CLICK, 			USE, FOREACH, GET_ATTR, CHECK_ATTR, MOVE_XY, CLICK, CLICK_XY, MOVE, DRAG_N_DROP, TEXT, PRESS, KEY_UP, KEY_DOWN, GET_VALUE, CHECK, CHECK_REGEXP, GET),
	...
	Table       	("Table", 			false,	GET_TABLE, 		USE, FOREACH, GET_ATTR, CHECK_ATTR, MOVE_XY, CLICK_XY, GET_VALUE_XY, TEXT_XY, CHECK_XY, CHECK_REGEXP_XY, PRESS, KEY_UP, KEY_DOWN, GET_ROW, GET_ROW_INDEXES, GET_ROW_BY_INDEX, GET_ROW_WITH_COLOR, GET_TABLE, GET_TABLE_SIZE, USE_CELL_COMPONENT),
	...
	Tree        	("Tree", 			false, 	CLICK, 			USE, FOREACH, GET_ATTR, CHECK_ATTR, MOVE_XY, CLICK, CLICK_XY, MOVE, PRESS, KEY_UP, KEY_DOWN, COLLAPSE, EXPAND, SELECT, GET_VALUE, GET_TREE, APPLY, SCROLL_TO),
