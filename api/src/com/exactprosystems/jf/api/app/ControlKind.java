...
{	// 											default			allOther
	...
	ComboBox    	("ComboBox", 		false,	SELECT,	SELECT_BY_INDEX, FOREACH, REPEAT, USE_LOCATOR, USE, COUNT, DELAY, GET_RECTANGLE, GET_ATTR, CHECK_ATTR, CHECK_ATTR_REGEXP, MOVE, MOVE_XY, CLICK,CLICK_XY, PRESS, KEY_UP, KEY_DOWN, GET_VALUE, CHECK, CHECK_REGEXP, GET, CLICK),
	...
	ListView    	("ListView", 		false, 	CLICK, SELECT, SELECT_BY_INDEX, 	FOREACH, REPEAT, USE_LOCATOR, USE, COUNT, DELAY, GET_RECTANGLE, GET_ATTR, CHECK_ATTR, CHECK_ATTR_REGEXP, MOVE, MOVE_XY, CLICK_XY, PRESS, KEY_UP, KEY_DOWN, GET_VALUE, CHECK, CHECK_REGEXP),
