...
public class AppFactoryFx extends AbstractApplicationFactory
{
    ...
    static
    {
        ...
        info.addTypes(ControlKind.Frame, Stage.class.getSimpleName());
    ...
    {
        return AppFactoryFx.class.getResourceAsStream(helpFileName);
    }
    ...
    {
        return RemoteApplicationFx.class.getCanonicalName();
    }
