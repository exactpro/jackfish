...
namespace UIAdapterRunner
{
    public partial class UIAdapterRunner : Form
    {
        public UIAdapterRunner()
        {
            ...
            UIAdapter.Program.FindAllForLocator(arr, arr.Length, null, (int)ControlKind.ComboBox, null, "//DataGrid", null, null, null, null, false, false);
            UIAdapter.Program.GetTable(getStringId(ref arr), false);
            ...
            UIAdapter.Program.getList(getStringId(ref arr),true);
